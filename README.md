...
Чтобы приступить к работе нужно загрузить файл с транзакциями или использовать базу данных (изменить строчку в Program.cs)
...
Приложение позволяет:
  ...
  - Сохранять в .csv файл или базу данных PostgreSQL
